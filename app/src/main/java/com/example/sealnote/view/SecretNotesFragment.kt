...
import com.example.sealnote.databinding.SecretNotePageBinding
import com.example.sealnote.viewmodel.SecretNotesViewModel

class SecretNotesFragment : Fragment() {
    private var _binding: SecretNotePageBinding? = null
    private val binding get() = _binding!!
    private val viewModel: SecretNotesViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        _binding = SecretNotePageBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.secretNotes.observe(viewLifecycleOwner) { notes ->
    ...
    private fun setupMenu(toolbar: Toolbar) {
        ...
        menuHost.addMenuProvider(object : MenuProvider {
            override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
                ...
                searchView.queryHint = "Search your secret notes..."
            }
